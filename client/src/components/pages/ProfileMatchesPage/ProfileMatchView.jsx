  ...
  render() {
    ...
    return (
      <div className="profile-main-view">
        <ProfilePicture
          imageUrl={this.props.match.data.profile.img}
          customSize="match-picture-size"
          isCircle={true}
        />
        <div className="match-details">
          <div className="match-detail">
            <p className="name">{this.props.match.data.profile.name}</p>
          ...
          <div className="match-detail">
            <p>
              ...
              {this.props.match.data.profile.email}
            </p>
            <p>
              <Icon icon={faMusic} />
              {this.props.match.data.profile.spotifyUrl}
            </p>
            <p>
              <Icon icon={faMusic} />
              {this.props.match.data.profile.spotifyUrl}
